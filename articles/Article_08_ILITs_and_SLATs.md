...
**Series:** Act 60 Trust Planning for High-Net-Worth Investors (Part 8 of 13)
...
Our SLAT template (available in the repository, file 8211) incorporates the following PR-compatible features:
...
Whether SLATs are appropriate for Act 60 couples depends on the couple's timeline and asset structure. For a couple with $25 million+ net worth, SLATs are nearly mandatory—the estate tax savings are substantial. For couples with $5-10 million, the analysis is more nuanced; a combination of annual gifts (with Crummey powers in an ILIT) may achieve sufficient tax savings with less complexity.

**Community property and SLAT funding.** If both spouses contributed assets to what is now characterized as marital community property, the grantor-spouse's unilateral transfer to a SLAT may require the non-grantor spouse's consent under PR law. This is particularly important for couples who owned PR real estate or PR business interests before establishing the SLAT.

**The *legítima* and SLAT planning.** The legítima requires that a percentage of the decedent's estate pass to forced heirs (typically children). If one spouse creates a SLAT that removes assets from the spouse's estate, whether the non-grantor spouse's interest in the SLAT (as discretionary beneficiary) counts toward the legítima calculation remains an open question. Alternatively, if the grantor dies first and the SLAT assets never passed through the grantor's estate, children may potentially challenge the SLAT as violating their legítima rights. Practitioners should confirm the current state of this area with PR succession law specialists, as the interaction between SLATs and legítima rights has not been definitively resolved.
...
Practitioners should obtain advice from PR succession law specialists before implementing a SLAT with substantial assets if the couple has multiple forced heirs (practitioners should confirm current requirements, as this area of law remains unsettled).
...
[1] IRC § 2042(2): "The value of the gross estate shall include the value of all property... if the decedent possessed at the time of his death any of the incidents of ownership, exercisable either alone or in conjunction with any other person."

[2] IRC § 2035(a): "If the decedent made a transfer... by gift within 3 years of the date of the decedent's death, the amount transferred is included in the decedent's gross estate."

[3] *Crummey v. Commissioner*, 397 F.2d 82 (9th Cir. 1968) (holding that withdrawal powers held by beneficiaries of a trust transform gifts to the trust into present interests qualifying for the annual exclusion).

[4] Puerto Rico Trust Act, 32 L.P.R.A. § 3352a: Trusts established after the act's effective date cannot be modified by the grantor unless the trust document explicitly provides otherwise. [Link to 32 L.P.R.A. statutory text]

[5] *TOLIC v. Rodríguez Febles*, 2007 P.R. LEXIS 53 (P.R. 2007): Puerto Rico Supreme Court upheld the validity and enforceability of insurance trusts and directed trust provisions under PR law.

[6] Puerto Rico Trust Act, 32 L.P.R.A. § 3352n--o: Permits appointment of trust protectors with specific powers including consent to distributions, trustee removal, and beneficiary-initiated modifications.

[7] *Estate of Grace*, 395 U.S. 316 (1969): Established the reciprocal trust doctrine, providing that simultaneous, mirror-image spousal trusts may be disregarded and included in both spouses' estates.

[8] Puerto Rico Trust Act, 32 L.P.R.A. § 3352h: Permits modification or termination of trusts without grantor consent if beneficiaries and trustee consent (with limited grantor involvement).

[9] IRC § 2036(a): Assets over which the grantor retained the right to income or control of beneficial enjoyment are included in the taxable estate.

[10] IRC § 2041: Addresses the tax treatment of powers of appointment; general powers are included in the holder's taxable estate; special powers are excluded.

---

## Related Articles in This Series

- **Article 1:** [Act 60 Fundamentals for High-Net-Worth Investors](#)
- **Article 2:** [Puerto Rico Residency Requirements and Tax Compliance](#)
- **Article 3:** [The Puerto Rico Trust Framework: Autonomous Estates and Irrevocability](#)
- **Article 4:** [Directed Trusts and Investment Control](#)
- **Article 5:** [Asset Protection Strategies Under PR Law](#)
- **Article 6:** [Charitable Planning and Act 60: Donor-Advised Funds and Private Foundations](#)
- **Article 7:** [Real Estate Planning for Act 60 Investors](#)
- **Article 9:** [Decanting and Modification: Flexibility in Irrevocable Trusts](#)
- **Article 10:** [Multi-Generational Planning and Multi-Generational Trusts](#)
- **Article 11:** [International Clients and the Act 60 Trust](#)
- **Article 12:** [Common Mistakes and IRS Challenges](#)
- **Article 13:** [Integration: The Complete Act 60 Plan](#)

---

## Disclaimer

This article is provided for educational purposes only and does not constitute legal, tax, or financial advice. The analysis reflects Puerto Rico law and U.S. federal tax law as of March 2026. Tax laws change frequently; state and federal court decisions may alter the analysis.

**Before implementing any ILIT, SLAT, or other trust structure:**
- Consult with a qualified Puerto Rico tax advisor regarding Act 60 compliance and PR-source income tax implications
- Obtain advice from a Puerto Rico attorney regarding trust domicile, legítima considerations, and property characterization
- Consult with a federal tax advisor (CPA or tax attorney) regarding IRC compliance, Crummey mechanisms, and estate tax optimization
- Review the trust document with an independent trustee and protector before execution

Act 60 planning is highly technical and fact-specific. Generic approaches often fail to optimize tax benefits or create unintended legal consequences. Professional guidance is essential.

---

**Author Bio:**
Hans Riefkohl is a Puerto Rico-based attorney whose practice focuses on Act 60 trust planning and high-net-worth estate structures. His practice focuses on the integration of federal tax law, Puerto Rico trust law, and multi-jurisdictional asset protection for U.S. and international clients relocating to Puerto Rico.

**Contact:** [hans@riefkohllaw.com](#)
**Office:** [Puerto Rico address](#)
