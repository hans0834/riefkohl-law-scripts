...
'/resources/what-is-puerto-rico-trust': {
  ...
  +'<p><strong>Revocability is now the default, and that is new.</strong> From the 1928 Act through January 29, 2027, the trustor could not reserve the right to revoke a Puerto Rico trust (PR Trust Act §3352h); the sole exception was for Act 60 Individual Resident Investor (IRI) decree holders under Section 2022.07(b) of the Incentives Code (13 LPRA §10854a(b)). <a href="/resources/revocable-trusts-puerto-rico">Act 153-2026</a> reversed that on January 30, 2027: any settlor may now create a revocable trust, and a deed that says nothing about revocability is presumed revocable. The practical burden has flipped — if you want irrevocability, and you generally do when the goal is asset protection, the deed must declare it. An irrevocable trust still lets the trustor reserve significant modification rights under §3352h—including the power to amend trust terms, substitute trustees, and add or remove beneficiaries—which provides flexibility comparable to a mainland revocable trust without the ability to collapse the trust entirely. (We explore this in detail in <a href="/resources/act-60-trust-planning">Article 2: Trust Planning for Act 60 Investors</a> and <a href="/resources/modifying-irrevocable-trusts">Article 3: How Modifiable Are Puerto Rico’s Irrevocable Trusts?</a>.)</p>'
...
'/resources/act-60-trust-planning': {
  ...
  +'<p>Until January 30, 2027, Act 60 Individual Resident Investor (IRI) decree holders held a tool no other Puerto Rico settlor had: the revocable trust, under the Incentives Code (Section 2022.07(b), codified at 13 LPRA §10854a(b)). <a href="/resources/revocable-trusts-puerto-rico">Act 153-2026</a> opened that tool to everyone and reversed the statutory presumption, so a deed silent on revocability is now presumed revocable. For decree holders the planning question therefore changes shape: not <em>whether</em> you may use a revocable trust, but whether you should. Revocable buys probate avoidance and incapacity continuity; irrevocable buys creditor protection, and it must now be declared expressly. Choosing between maintaining your mainland trust and creating a new Puerto Rico trust remains the central decision for Act 60 investors.</p>'

  +'<h2>The Rule That Changed: Revocability Is Now the Default</h2>'

  +'<p>From the 1928 Act through January 29, 2027, the grantor could not reserve the right to revoke a Puerto Rico trust (PR Trust Act §3352h) — a mandatory rule the trust instrument could not override. Act 153-2026 changed that on January 30, 2027. A Puerto Rico trust may now be revocable or irrevocable as the deed expressly provides, and if the deed is silent it is <strong>presumed revocable</strong> unless its own clauses clearly show a contrary intent. Everything below about modification rights still applies to a trust you choose to make irrevocable.</p>'
...
'/resources/special-needs-trusts-medicaid': {
  ...
  +'<p><strong>PR-Specific Note:</strong> Since <a href="/resources/revocable-trusts-puerto-rico">Act 153-2026</a> took effect on January 30, 2027, any settlor in Puerto Rico may create a revocable trust, and a deed silent on revocability is presumed revocable — the reverse of the rule that governed from 2012 to 2027, when only Act 60 IRI decree holders could (13 LPRA §10854a(b)). For special-needs planning the default is the wrong one: a revocable trust leaves assets reachable by the settlor’s creditors and countable, so a third-party <em>irrevocable</em> trust remains the tool, and the deed must now say so expressly. This section describes mainland Medicaid rules that have limited applicability in PR.</p>'
...
'/resources/ilits-and-slats': {
  ...
  +'<ol>'
  +'<li><strong>Irrevocability must be declared:</strong> since <a href="/resources/revocable-trusts-puerto-rico">Act 153-2026</a> took effect on January 30, 2027, a Puerto Rico trust deed that is silent on revocability is presumed <em>revocable</em> — the reverse of the prior rule. An ILIT depends on irrevocability, so the deed must state it expressly; any retained power to revoke or withdraw would leave the assets reachable by the grantor’s creditors and undermine the estate-tax result.</li>'
  ...
  +'<li>Governed by the Puerto Rico Trust Act, with irrevocability declared expressly in the deed (required since Act 153-2026)</li>'
...
'/resources/trust-costs-puerto-rico': {
  ...
  +'<li><strong>Standard revocable living trust</strong> (multiple beneficiaries, real property, modest complexity): $3,500–$7,500. <em>Note: since Act 153-2026 took effect on January 30, 2027, any settlor may create a revocable trust in Puerto Rico — the option is no longer limited to Act 60 IRI decree holders. Absent an express provision in the constitutive deed, the trust is now presumed <strong>revocable</strong>, the reverse of the prior rule.</em></li>'
...
'/resources/mainland-trust-to-puerto-rico': {
  ...
  +'<p>What does this mean in practice? Law 219-2012 provides a comprehensive legal framework for trusts in Puerto Rico, but it operates on civil law principles fundamentally different from those governing your mainland trust. PR trusts must be created by public deed (escritura pública) for inter vivos trusts or by will for testamentary trusts. Since Act 153-2026 took effect on January 30, 2027 a Puerto Rico trust is presumed revocable unless the deed declares otherwise, which reversed the rule that governed from 2012 to 2027. The civil law concepts of ownership and autonomous patrimony do not map onto the common law trust’s division of legal and equitable title. A mainland trust designed around common law concepts of dual title and revocability will encounter structural friction when its administration moves to Puerto Rico.</p>'
