...
'/resources/what-is-puerto-rico-trust': {
  ...
  +'<p><strong>Revocability is about to become the default, and that is new.</strong> From the 1928 Act through January 29, 2027, the trustor cannot reserve the right to revoke a Puerto Rico trust (PR Trust Act §3352h); the sole exception is for Act 60 Individual Resident Investor (IRI) decree holders under Section 2022.07(b) of the Incentives Code (13 LPRA §10854a(b)). <a href="/resources/revocable-trusts-puerto-rico">Act 153-2026</a> reverses that on January 30, 2027: from that date, any settlor may create a revocable trust, and a deed that says nothing about revocability will be presumed revocable. The practical burden will flip — if you want irrevocability, and you generally do when the goal is asset protection, the deed must declare it. An irrevocable trust still lets the trustor reserve significant modification rights under §3352h—including the power to amend trust terms, substitute trustees, and add or remove beneficiaries—which provides flexibility comparable to a mainland revocable trust without the ability to collapse the trust entirely. (We explore this in detail in <a href="/resources/act-60-trust-planning">Article 2: Trust Planning for Act 60 Investors</a> and <a href="/resources/modifying-irrevocable-trusts">Article 3: How Modifiable Are Puerto Rico’s Irrevocable Trusts?</a>.)</p>'
  ...
  +'<div style="background:#f8f6f0;border-left:4px solid #bfa35d;padding:16px 20px;margin:24px 0;border-radius:0 8px 8px 0;"><p style="margin:0 0 8px;font-size:.88rem;"><strong>Continue Reading:</strong></p><ul style="margin:0;padding:0 0 0 18px;font-size:.85rem;"><li><a href="/resources/complete-guide-puerto-rico-trusts" style="color:#a68c42;">The Complete Guide to Puerto Rico Trusts</a> \u2014 Everything you need to know in one place</li><li><a href="/resources/avoiding-probate-legitima" style="color:#a68c42;">Avoiding Probate: Trusts and the Leg\u00edtima</a> \u2014 How forced heirship works and how to plan around it</li><li><a href="/resources/trust-costs-puerto-rico" style="color:#a68c42;">Trust Costs in Puerto Rico</a> \u2014 Fees, taxes, and ongoing expenses</li><li><a href="/resources/act-60-trust-planning" style="color:#a68c42;">Trust Planning for Act 60 Investors</a> \u2014 Mainland revocable trust vs. PR irrevocable trust</li></ul></div>'
  ...
  +'<div class="rl-sub-cta"><p><strong>Ready to explore if a Puerto Rico trust is right for you?</strong></p><p>We create trusts under Law 219-2012 tailored to your assets, family, and goals. Flat fee, no hourly billing.</p><a href="/calendly">Book a Free Strategy Call</a></div>'
  }
},
...
'/resources/act-60-trust-planning': {
  ...
  +'<p>Until January 30, 2027, Act 60 Individual Resident Investor (IRI) decree holders hold a tool no other Puerto Rico settlor has: the revocable trust, under the Incentives Code (Section 2022.07(b), codified at 13 LPRA §10854a(b)). <a href="/resources/revocable-trusts-puerto-rico">Act 153-2026</a> opens that tool to everyone on that date and reverses the statutory presumption, so a deed silent on revocability will be presumed revocable. For decree holders the planning question therefore changes shape: not <em>whether</em> you may use a revocable trust, but whether you should. Revocable buys probate avoidance and incapacity continuity; irrevocable buys creditor protection, and once the amendment takes effect it must be declared expressly. Choosing between maintaining your mainland trust and creating a new Puerto Rico trust remains the central decision for Act 60 investors.</p>'

  +'<h2>The Rule That Is Changing: Revocability Becomes the Default</h2>'

  +'<p>From the 1928 Act through January 29, 2027, the grantor cannot reserve the right to revoke a Puerto Rico trust (PR Trust Act §3352h) — a mandatory rule the trust instrument cannot override. Act 153-2026 changes that on January 30, 2027. From that date a Puerto Rico trust may be revocable or irrevocable as the deed expressly provides, and if the deed is silent it will be <strong>presumed revocable</strong> unless its own clauses clearly show a contrary intent. Everything below about modification rights still applies to a trust you choose to make irrevocable.</p>'
...
'/resources/asset-protection-trusts-pr': {
  ...
  +'<p>Irrevocability is what does the protective work here, and beginning January 30, 2027 you will have to ask for it in writing. <a href="/resources/revocable-trusts-puerto-rico">Act 153-2026</a> — the enacted form of P. del S. 773, signed July 30, 2026 — writes the revocable trust into the Trust Act effective that date and reverses the presumption: a deed silent on revocability will be presumed <em>revocable</em>. Until then the reverse remains true, as it has since 2012, and only Act 60 Individual Resident Investor decree holders may create a revocable trust (13 LPRA §10854a(b)). For asset protection the consequence is direct: Act 153-2026 provides that assets which remain subject to the settlor’s power of revocation or withdrawal may be reached by the settlor’s creditors <strong>as if the trust did not exist</strong>. A trust meant to shield assets must therefore declare itself irrevocable expressly, and the settlor must not retain a revocation or withdrawal power. Within an irrevocable trust the settlor may still reserve modification powers under §3352h without revoking outright.</p>'
...
'/resources/special-needs-trusts-medicaid': {
  ...
  +'<p><strong>PR-Specific Note:</strong> Once <a href="/resources/revocable-trusts-puerto-rico">Act 153-2026</a> takes effect on January 30, 2027, any settlor in Puerto Rico may create a revocable trust, and a deed silent on revocability will be presumed revocable — the reverse of the rule in force since 2012, under which only Act 60 IRI decree holders may (13 LPRA §10854a(b)). For special-needs planning the default is the wrong one: a revocable trust leaves assets reachable by the settlor’s creditors and countable, so a third-party <em>irrevocable</em> trust remains the tool, and once the new rule applies the deed must say so expressly. This section describes mainland Medicaid rules that have limited applicability in PR.</p>'
...
'/resources/ilits-and-slats': {
  ...
  +'<ol>'
  +'<li><strong>Irrevocability must be declared:</strong> once <a href="/resources/revocable-trusts-puerto-rico">Act 153-2026</a> takes effect on January 30, 2027, a Puerto Rico trust deed that is silent on revocability will be presumed <em>revocable</em> — the reverse of the current rule. An ILIT depends on irrevocability, so the deed must state it expressly; any retained power to revoke or withdraw would leave the assets reachable by the grantor’s creditors and undermine the estate-tax result.</li>'
  ...
  +'<li>Governed by the Puerto Rico Trust Act, with irrevocability declared expressly in the deed (required once Act 153-2026 takes effect on January 30, 2027)</li>'
  ...
  +'<li><a href="/resources/what-is-puerto-rico-trust">What Is a Puerto Rico Trust? A Guide for Act 60 Investors</a></li>'
  +'</ul>'
...
'/resources/trust-costs-puerto-rico': {
  ...
  +'<li><strong>Standard revocable living trust</strong> (multiple beneficiaries, real property, modest complexity): $3,500–$7,500. <em>Note: once Act 153-2026 takes effect on January 30, 2027, any settlor may create a revocable trust in Puerto Rico — the option will no longer be limited to Act 60 IRI decree holders. Absent an express provision in the constitutive deed, the trust will then be presumed <strong>revocable</strong>, the reverse of the current rule.</em></li>'
  ...
  +'<div style="background:#f8f6f0;border-left:4px solid #bfa35d;padding:16px 20px;margin:24px 0;border-radius:0 8px 8px 0;"><p style="margin:0 0 8px;font-size:.88rem;"><strong>Continue Reading:</strong></p><ul style="margin:0;padding:0 0 0 18px;font-size:.85rem;"><li><a href="/resources/complete-guide-puerto-rico-trusts" style="color:#a68c42;">The Complete Guide to Puerto Rico Trusts</a> \u2014 Full overview of trust planning under Law 219-2012</li><li><a href="/resources/avoiding-probate-legitima" style="color:#a68c42;">Avoiding Probate: Trusts and the Leg\u00edtima</a> \u2014 How forced heirship works and how to plan around it</li><li><a href="/resources/what-is-puerto-rico-trust" style="color:#a68c42;">What Is a Puerto Rico Trust?</a> \u2014 The autonomous estate concept explained</li><li><a href="/resources/fiduciary-duties-trustees" style="color:#a68c42;">Fiduciary Duties Under Puerto Rico Trust Law</a> \u2014 What trustees must do and how beneficiaries are protected</li></ul></div>'

  +'<div class="rl-sub-cta"><p><strong>Want a transparent cost breakdown for your trust?</strong></p><p>We use flat-fee pricing for trust creation and provide a detailed cost estimate in your first call. No hourly billing.</p><a href="/calendly">Book a Free Strategy Call</a></div>'
  }
},
...
'/resources/mainland-trust-to-puerto-rico': {
  ...
  +'<p>What does this mean in practice? Law 219-2012 provides a comprehensive legal framework for trusts in Puerto Rico, but it operates on civil law principles fundamentally different from those governing your mainland trust. PR trusts must be created by public deed (escritura pública) for inter vivos trusts or by will for testamentary trusts. Once Act 153-2026 takes effect on January 30, 2027 a Puerto Rico trust will be presumed revocable unless the deed declares otherwise, reversing the rule that has governed since 2012. The civil law concepts of ownership and autonomous patrimony do not map onto the common law trust’s division of legal and equitable title. A mainland trust designed around common law concepts of dual title and revocability will encounter structural friction when its administration moves to Puerto Rico.</p>'
