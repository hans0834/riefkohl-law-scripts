...
'/resources/trust-vs-will-puerto-rico': {
  ...
  +'<p>Trusts (<em>fideicomiso</em>) are governed by <a href="/puerto-rico-trusts">Law 219-2012</a>. A <strong>revocable trust</strong> avoids probate and provides incapacity planning but does not protect assets from creditors. An <strong>irrevocable trust</strong> provides asset protection, estate tax reduction, and multi-generational planning. <strong>Multi-generational trusts</strong> can last up to 70 years from the date the trust takes effect.</p>'
