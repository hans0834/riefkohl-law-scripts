...
'/resources-act60': {
  ...
  +'<li><strong>Dynasty trusts:</strong> Allow multi-generational wealth transfer while maintaining trust benefits across generations.</li></ul>'
...
'/resources/act-60-estate-planning-mistakes': {
  ...
  +'<p>U.S. citizens in Puerto Rico are subject to federal estate tax on worldwide assets. Puerto Rico also imposes its own estate tax. Act 60 income tax exemptions do <strong>not</strong> extend to estate and gift taxes. Without proper planning, some assets could face both federal and Puerto Rico estate tax.</p>'
...
'/resources/trust-vs-will-puerto-rico': {
  ...
  +'<p>Trusts (<em>fideicomiso</em>) are governed by <a href="/puerto-rico-trusts">Law 219-2012</a>. A <strong>revocable trust</strong> avoids probate and provides incapacity planning but does not protect assets from creditors. An <strong>irrevocable trust</strong> provides asset protection, estate tax reduction, and multi-generational planning. <strong>Dynasty trusts</strong> can last up to 70 years from the date the trust takes effect.</p>'
...
'/resources/asset-protection-irrevocable-trusts': {
  ...
  +'<p>Law 219-2012 provides a modern trust statute with strong creditor protections, self-settled trust provisions, and long trust duration (up to 70 years). Puerto Rico\u2019s civil law system means certain doctrines creditors use on the mainland may not apply here.</p>'
...
'/resources/complete-guide-puerto-rico-trusts': {
  ...
  +'<p>Designed to last multiple generations (up to 70 years under Law 219-2012). Assets pass without probate or estate tax at each generation.</p>'
...
'/resources/ley-60-guia-inversionistas': {
  ...
  +'<h2>Requisitos de residencia</h2>'
  +'<ul><li><strong>Presencia f\u00edsica:</strong> Al menos 183 d\u00edas en Puerto Rico</li>'
  +'<li><strong>Hogar contributivo:</strong> Su lugar principal de actividad econ\u00f3mica debe estar en PR</li>'
  +'<li><strong>Conexi\u00f3n m\u00e1s estrecha:</strong> Residencia principal, registro de votante, licencia de conducir, cuentas bancarias, m\u00e9dico y participaci\u00f3n comunitaria en PR</li></ul>'
