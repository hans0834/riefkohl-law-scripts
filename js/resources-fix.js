...
/* Act 153-2026 cornerstone pages — FLIP TO true once
...
'/resources-faq': {
  ...
  +'<div class="rl-faq-a"><p>Yes — but since January 30, 2027 you have to say so expressly. Act 153-2026 amended the Trust Act (Ley 219-2012) to recognize the revocable trust and reverse the old presumption: a deed that is silent on revocability is now presumed <em>revocable</em>. Irrevocability is what delivers creditor protection, because assets that remain subject to a retained power to revoke or withdraw can be reached by the settlor’s creditors as if the trust did not exist. An irrevocable trust can still be <em>modified</em> in significant ways under §3352h—changing beneficiaries, trustees, and distribution standards—providing flexibility without sacrificing that protection.</p></div></div>'
...
'/resources-wills-vs-trusts': {
  ...
  +'<ul><li><strong>Irrevocable trust:</strong> Since Act 153-2026 took effect on January 30, 2027, irrevocability must be stated expressly in the deed. The grantor cannot revoke the trust, but may reserve broad modification rights under §3352h (amend terms, change beneficiaries, substitute trustees), providing flexibility with strong asset protection.</li>'
  +'<li><strong>Revocable trust:</strong> Since January 30, 2027 any settlor may establish one; before Act 153-2026 the option belonged only to Act 60 Individual Resident Investor decree holders (13 LPRA §10854a(b)). The grantor retains the right to modify or revoke during their lifetime, but the trust does not protect assets from creditors while that power survives.</li>'
...
'/resources/trust-vs-will-puerto-rico': {
  ...
  +'<p>Trusts (<em>fideicomiso</em>) are governed by <a href="/puerto-rico-trusts">Law 219-2012</a>, as amended by Act 153-2026. Since January 30, 2027 a trust is presumed <strong>revocable</strong> unless the deed declares otherwise, and any settlor may create one — an option previously limited to Act 60 IRI decree holders (13 LPRA §10854a(b)). A revocable trust avoids probate and provides incapacity planning, but does not protect assets from creditors while the power to revoke survives. <strong>Irrevocable trusts</strong>, which must now be declared expressly, provide asset protection, estate tax reduction, and multi-generational planning, and the grantor may still reserve broad modification rights under §3352h. Trust duration under Law 219-2012 is measured by the life of the last surviving beneficiary named in the trust instrument, plus 30 years (with certain special-purpose trusts potentially extending to 90 years).</p>'
...
'/resources/complete-guide-puerto-rico-trusts': {
  ...
  +'<p><strong>Have questions about Puerto Rico trust planning?</strong></p>'
  ...
  +'<p>Since Act 153-2026 took effect on January 30, 2027, irrevocability must be declared expressly in the deed — a silent deed is presumed revocable. The grantor cannot revoke an irrevocable trust, but may reserve broad modification rights under §3352h—including amending trust terms, substituting trustees, and adding or removing beneficiaries. Provides strong asset protection, estate tax reduction, and multi-generational planning. Must be structured to respect <a href="/resources/forced-heirship-estate-plan">forced heirship rules</a>.</p>'
  +'<h3>Revocable Trusts</h3>'
  +'<p>Since January 30, 2027 any settlor may establish a revocable trust; before Act 153-2026 the option belonged only to Act 60 Individual Resident Investor decree holders (13 LPRA §10854a(b)). Can be modified or revoked at any time by public deed. Provides probate avoidance and incapacity planning, but no asset protection while the power to revoke survives. All income is reported on the settlor’s personal tax return.</p>'
...
'/resources/act-38-2026-hb-505': {
  ...
  +'<li><strong>No change to your $10,000 donation obligation or $5,000 annual report fee</strong></li>'
  ...
  +'<li><strong>Plan for the $10,000 donation, $5,000 annual report fee, and employment requirements</strong> when budgeting your relocation</li>'
  +'<li><strong>Note the donation allocation:</strong> $5,000 to CECFL-listed organizations + $5,000 to qualifying PR nonprofits (not controlled by you or your family)</li></ul>'
...
function injectResourceCards() {
  ...
  var sections = [
    {
      ...
      icon: '\uD83D\uDEE1\uFE0F',
      cards: [
        /* Act 153-2026 cornerstone. Gated on ACT153_PAGES_LIVE (top of file) so the
           hub never links at a 404 before the Squarespace page exists. */
    ...
    },
    {
      ...
      cards: [
        ...
        { title: 'Requisitos de la Ley 60 en 2026', desc: 'Todos los requisitos para cualificar y conservar un decreto de Ley 60 \u2014 residencia bona fide, fecha l\u00EDmite, compra de vivienda, donaci\u00F3n e informes anuales.', url: '/resources/requisitos-ley-60', lang: 'es' },
        { title: '\u00BFTodav\u00EDa Paga Impuestos Federales en PR?', desc: 'Mudarse a Puerto Rico cambia sus impuestos federales \u2014 no los elimina. Qu\u00E9 excluye el IRC \u00A7933 y qu\u00E9 sigue debiendo ante el IRS.', url: '/resources/pagas-impuestos-federales-en-puerto-rico', lang: 'es' },
  ...
  /* Lead the trusts group with the Act 153-2026 cornerstone once it is published. */
  if (ACT153_PAGES_LIVE) {
    sections[0].cards.unshift({
      title: 'Revocable Trusts: What Act 153-2026 Changes',
      desc: 'Act 153-2026 legalizes the revocable trust in Puerto Rico effective January 30, 2027 and reverses the irrevocability presumption — what changes, who it affects, and what to review before it takes effect.',
      url: '/resources/revocable-trusts-puerto-rico'
    });
  }
